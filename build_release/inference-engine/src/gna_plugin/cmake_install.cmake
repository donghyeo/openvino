...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xgnax" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/deployment_tools/inference_engine/lib/intel64" TYPE MODULE FILES "/home/donghyeon/openvino_andrew/bin/intel64/Release/lib/libGNAPlugin.so")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/deployment_tools/inference_engine/lib/intel64/libGNAPlugin.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/deployment_tools/inference_engine/lib/intel64/libGNAPlugin.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/deployment_tools/inference_engine/lib/intel64/libGNAPlugin.so"
         OLD_RPATH "/home/donghyeon/openvino_andrew/bin/intel64/Release/lib:/home/donghyeon/openvino_andrew/inference-engine/temp/tbb/lib:/home/donghyeon/openvino_andrew/inference-engine/temp/gna_02.00.00.1047.1/linux/x64:"
         NEW_RPATH "")
