...
NGRAPH_TEST(IE_GPU, onnx_model_lstm_fwd_default_const)
{
...
NGRAPH_TEST(IE_GPU, onnx_model_lstm_reverse_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_lstm_bidir_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_lstm_fwd_with_clip_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_lstm_fwd_mixed_seq_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_lstm_reverse_mixed_seq_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_lstm_bidir_mixed_seq_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_lstm_fwd_with_clip_peepholes)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_lstm_fwd_mixed_seq)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_lstm_fwd_hardsigmoid_activation)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_lstm_fwd_large_batch_no_clip)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_lstm_bdir_short_input_seq_peepholes)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_lstm_mixed_seq_reverse)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_import_only_lstm_dynamic_batch_seq_all_inputs)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_import_only_lstm_dynamic_batch_seq_3_inputs)
{
...
NGRAPH_TEST(IE_GPU, onnx_model_lstm_dynamic_batch_size_and_seq_len)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_gru_defaults_fwd_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_gru_defaults_fwd)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_gru_fwd_activations_const)
{
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_gru_fwd_activations)
{
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_gru_fwd_mixed_seq_len)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_gru_fwd_mixed_seq_len_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_gru_reverse_mixed_seq_len_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_gru_bidir_mixed_seq_len_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_gru_rev_clip)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_gru_rev_clip_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_gru_reverse_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_gru_reverse)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_gru_fwd_bias_initial_h_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_gru_fwd_bias_initial_h)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_gru_bidirectional_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_gru_bidirectional)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_gru_fwd_linear_before_reset_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_gru_fwd_linear_before_reset)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_gru_defaults_fwd_const_dynamic)
{
    auto function = onnx_import::import_onnx_model(file_util::path_join(
...
NGRAPH_TEST_F(IE_GPU, GRUSequenceOp, onnx_model_import_only_gru_defaults_fwd_const_dynamic)
{
    auto function = onnx_import::import_onnx_model(file_util::path_join(
        SERIALIZED_ZOO, "onnx/dynamic_shapes/gru_defaults_fwd_const_dynamic.prototxt"));
...
NGRAPH_TEST_F(IE_GPU, RNNSequenceOp, onnx_model_rnn_defaults_fwd_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, RNNSequenceOp, onnx_model_rnn_defaults_fwd)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, RNNSequenceOp, onnx_model_rnn_fwd_activations_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, RNNSequenceOp, onnx_model_rnn_fwd_activations)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, RNNSequenceOp, onnx_model_rnn_fwd_mixed_seq_len_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, RNNSequenceOp, onnx_model_rnn_fwd_mixed_seq_len)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, RNNSequenceOp, onnx_model_rnn_reverse_mixed_seq_len_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, RNNSequenceOp, onnx_model_rnn_bidir_mixed_seq_len_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, RNNSequenceOp, onnx_model_rnn_rev_clip_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, RNNSequenceOp, onnx_model_rnn_rev_clip)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, RNNSequenceOp, onnx_model_rnn_reverse_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, RNNSequenceOp, onnx_model_rnn_reverse)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, RNNSequenceOp, onnx_model_rnn_fwd_bias_initial_h_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, RNNSequenceOp, onnx_model_rnn_fwd_bias_initial_h)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, RNNSequenceOp, onnx_model_rnn_bidirectional)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, RNNSequenceOp, onnx_model_rnn_bidirectional_const)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST_F(IE_GPU, RNNSequenceOp, onnx_model_rnn_defaults_fwd_const_dynamic)
{
    auto function = onnx_import::import_onnx_model(file_util::path_join(
...
NGRAPH_TEST_F(IE_GPU, RNNSequenceOp, onnx_model_import_only_rnn_defaults_fwd_const_dynamic)
{
    auto function = onnx_import::import_onnx_model(file_util::path_join(
        SERIALIZED_ZOO, "onnx/dynamic_shapes/rnn_defaults_fwd_const_dynamic.prototxt"));
