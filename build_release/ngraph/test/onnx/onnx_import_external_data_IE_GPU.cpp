...
NGRAPH_TEST(IE_GPU, onnx_external_data)
{
...
NGRAPH_TEST(IE_GPU, onnx_external_data_from_stream)
{
    std::string path =
        file_util::path_join(SERIALIZED_ZOO, "onnx/external_data/external_data.prototxt");
...
NGRAPH_TEST(IE_GPU, onnx_external_data_optinal_fields)
{
...
NGRAPH_TEST(IE_GPU, onnx_external_data_in_different_paths)
{
...
NGRAPH_TEST(IE_GPU, onnx_external_two_tensors_data_in_the_same_file)
{
    auto function = onnx_import::import_onnx_model(file_util::path_join(
        SERIALIZED_ZOO,
...
NGRAPH_TEST(IE_GPU, onnx_external_invalid_external_data_exception)
{
    try
    {
        auto function = onnx_import::import_onnx_model(file_util::path_join(
...
NGRAPH_TEST(IE_GPU, onnx_external_invalid_up_dir_path)
{
    try
    {
        auto function = onnx_import::import_onnx_model(file_util::path_join(
...
NGRAPH_TEST(IE_GPU, onnx_external_data_sanitize_path)
{
    const auto function = onnx_import::import_onnx_model(file_util::path_join(
