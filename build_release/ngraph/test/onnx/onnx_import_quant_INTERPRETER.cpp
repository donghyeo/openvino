...
NGRAPH_TEST(INTERPRETER, onnx_model_quantize_linear_const_scale_const_zero_p)
{
...
NGRAPH_TEST(INTERPRETER, onnx_model_quantize_linear)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(INTERPRETER, onnx_model_quantize_linear_zero_point)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(INTERPRETER, onnx_model_quantize_linear_axis_zero)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(INTERPRETER, onnx_model_quantize_linear_axis_negative)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(INTERPRETER, onnx_model_dequantize_linear)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(INTERPRETER, onnx_model_dequantize_linear_scalar_zero_scale_uint8)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(INTERPRETER, onnx_model_dequantize_linear_scalar_zero_scale_int8)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(INTERPRETER, onnx_model_dequantize_linear_1d_zero_scale_uint8)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(INTERPRETER, onnx_model_dequantize_linear_1d_zero_scale_int8)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(INTERPRETER, onnx_model_dequantize_linear_1d_zero_scale_int8_4d)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(INTERPRETER, onnx_model_dequantize_linear_1d_zero_scale_uint8_negative_axis)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(INTERPRETER, onnx_model_quant_conv_linear)
{
    auto function = onnx_import::import_onnx_model(
    ...
    std::vector<std::vector<std::int8_t>> outputs{
        execute<std::uint8_t, std::int8_t>(function, inputs, "INTERPRETER")};
    EXPECT_TRUE(test::all_close(expected_output.front(), outputs.front()));
}

NGRAPH_TEST(INTERPRETER, onnx_model_quant_conv_linear_2d)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(INTERPRETER, onnx_model_quant_conv_linear_3d)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(INTERPRETER, onnx_model_qlinear_matmul_3d)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(INTERPRETER, onnx_model_conv_integer)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(INTERPRETER, onnx_model_conv_integer_zero_point_zero)
{
    auto function = onnx_import::import_onnx_model(
        file_util::path_join(SERIALIZED_ZOO, "onnx/conv_integer.prototxt"));
    auto test_case = test::TestCase<TestEngine>(function);
...
NGRAPH_TEST(INTERPRETER, onnx_model_conv_integer_no_zero_point)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(INTERPRETER, onnx_model_conv_integer_pads)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(INTERPRETER, onnx_model_fake_quantize_import_only)
{
...
NGRAPH_TEST(INTERPRETER, onnx_model_fake_quantize_const_inputs_infer)
{
    const auto function = onnx_import::import_onnx_model(file_util::path_join(
        SERIALIZED_ZOO, "onnx/quantization/fake_quantize_const_inputs.prototxt"));
...
NGRAPH_TEST(INTERPRETER, onnx_model_fake_quantize_nonconst_inputs_infer)
{
    const auto function = onnx_import::import_onnx_model(file_util::path_join(
