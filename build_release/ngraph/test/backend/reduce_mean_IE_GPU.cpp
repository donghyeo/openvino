...
NGRAPH_TEST(IE_GPU, reduce_mean_to_scalar)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(IE_GPU, reduce_mean_to_scalar_int8)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(IE_GPU, reduce_mean_matrix_columns)
{
    Shape shape_a{3, 2};
...
NGRAPH_TEST(IE_GPU, reduce_mean_matrix_rows)
{
    Shape shape_a{3, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{3};
...
NGRAPH_TEST(IE_GPU, reduce_mean_matrix_rows_int32)
{
    Shape shape_a{3, 2};
...
NGRAPH_TEST(IE_GPU, reduce_mean_keep_to_scalar)
{
    Shape shape{2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto axes = make_shared<op::Constant>(element::i32, Shape{2}, vector<int32_t>{0, 1});
...
NGRAPH_TEST(IE_GPU, reduce_mean_keep_to_scalar_int8)
{
    Shape shape{2, 2};
    auto A = make_shared<op::Parameter>(element::i8, shape);
    auto axes = make_shared<op::Constant>(element::i32, Shape{2}, vector<int32_t>{0, 1});
...
NGRAPH_TEST(IE_GPU, reduce_mean_keep_matrix_columns)
{
    Shape shape_a{3, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{1, 2};
...
NGRAPH_TEST(IE_GPU, reduce_mean_keep_matrix_rows)
{
    Shape shape_a{3, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{3, 1};
...
NGRAPH_TEST(IE_GPU, reduce_mean_keep_matrix_rows_int32)
{
    Shape shape_a{3, 2};
    auto A = make_shared<op::Parameter>(element::i32, shape_a);
    Shape shape_rt{3, 1};
...
NGRAPH_TEST(IE_GPU, reduce_mean_matrix_columns_dynamic)
{
...
NGRAPH_TEST(IE_GPU, reduce_mean_matrix_rows_dynamic)
{
    auto A = make_shared<op::Parameter>(element::f32, PartialShape::dynamic());
    auto axes = make_shared<op::Constant>(element::i32, Shape{}, 1);
    auto f =
...
NGRAPH_TEST(IE_GPU, reduce_mean_keep_matrix_columns_dynamic)
{
    auto A = make_shared<op::Parameter>(element::f32, PartialShape::dynamic());
    auto axes = make_shared<op::Constant>(element::i32, Shape{}, 0);
    auto f =
...
NGRAPH_TEST(IE_GPU, reduce_mean_keep_matrix_rows_dynamic)
{
    auto A = make_shared<op::Parameter>(element::f32, PartialShape::dynamic());
    auto axes = make_shared<op::Constant>(element::i32, Shape{}, 1);
    auto f =
