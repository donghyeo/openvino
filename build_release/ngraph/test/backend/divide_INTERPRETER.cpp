...
NGRAPH_TEST(INTERPRETER, divide)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(INTERPRETER, divide_int32)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(INTERPRETER, divide_cpp_rounding_int32)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(INTERPRETER, divide_python_rounding_int32)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(INTERPRETER, divide_overload)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(INTERPRETER, divide_by_zero_float32)
{
    Shape shape{2, 2};
