...
NGRAPH_TEST(INTERPRETER, shape_of_scalar_v0)
{
    Shape input_shape{};
...
NGRAPH_TEST(INTERPRETER, shape_of_scalar_v3)
{
    Shape input_shape{};
    Shape output_shape{0};
...
NGRAPH_TEST(INTERPRETER, shape_of_vector_v0)
{
    Shape input_shape{2};
...
NGRAPH_TEST(INTERPRETER, shape_of_vector_v3)
{
    Shape input_shape{2};
    Shape output_shape{1};
...
NGRAPH_TEST(INTERPRETER, shape_of_matrix_v0)
{
...
NGRAPH_TEST(INTERPRETER, shape_of_matrix_v3)
{
    Shape input_shape{2, 4};
    Shape output_shape{2};
...
NGRAPH_TEST(INTERPRETER, shape_of_5d_v0)
{
...
NGRAPH_TEST(INTERPRETER, shape_of_5d_v3)
{
    Shape input_shape{2, 4, 8, 16, 32};
    Shape output_shape{5};
