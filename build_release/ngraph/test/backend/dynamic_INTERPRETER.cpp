...
NGRAPH_TEST(INTERPRETER, create_dynamic_backend)
{
...
NGRAPH_TEST(INTERPRETER, create_dynamic_tensor)
{
    auto backend = runtime::Backend::create("INTERPRETER", true);
...
NGRAPH_TEST(INTERPRETER, dynamic_abc)
{
    //
...
NGRAPH_TEST(INTERPRETER, dynamic_axpy)
{
    // Test with shape {?, 3, 3}.
...
NGRAPH_TEST(INTERPRETER, dynamic_to_vector)
{
    // Test with shape {?, 3, 3}.
...
NGRAPH_TEST(INTERPRETER, dynamic_reverse_shape)
{
    // Test with shape {?, 3, 3}.
...
NGRAPH_TEST(INTERPRETER, dynamic_transpose)
{
