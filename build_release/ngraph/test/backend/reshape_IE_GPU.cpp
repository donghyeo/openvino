...
NGRAPH_TEST(IE_GPU, reshape_t2v)
{
    Shape shape_a{2, 2, 3};
...
NGRAPH_TEST(IE_GPU, reshape_t2s)
{
    Shape shape_a{1, 1, 1};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_r{};
...
NGRAPH_TEST(IE_GPU, reshape_s2t)
{
    Shape shape_a{};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(IE_GPU, reshape_s2t1)
{
    Shape shape_a{};
...
NGRAPH_TEST(IE_GPU, reshape_v2m_col)
{
    Shape shape_a{3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_r{3, 1};
...
NGRAPH_TEST(IE_GPU, reshape_v2m_row)
{
    Shape shape_a{3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_r{1, 3};
...
NGRAPH_TEST(IE_GPU, reshape_v2t_middle)
{
    Shape shape_a{3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_r{1, 3, 1};
...
NGRAPH_TEST(IE_GPU, reshape_m2m_same)
{
    Shape shape_a{3, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_r{3, 3};
...
NGRAPH_TEST(IE_GPU, reshape_special_zero)
{
...
NGRAPH_TEST(IE_GPU, builder_reshape_1D_to_scalar)
{
...
NGRAPH_TEST(IE_GPU, builder_reshape_3D_to_scalar)
{
...
NGRAPH_TEST(IE_GPU, reshape_shufflenet_5d)
{
