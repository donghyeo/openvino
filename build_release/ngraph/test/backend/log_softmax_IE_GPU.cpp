...
NGRAPH_TEST(IE_GPU, log_softmax_1d_single_value)
{
    Shape shape{1};
...
NGRAPH_TEST(IE_GPU, log_softmax_2d_axis0)
{
    Shape shape{2, 4};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, log_softmax_2d_axis1)
{
    Shape shape{2, 4};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, log_softmax_2d_axis_neg1)
{
    Shape shape{2, 4};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, log_softmax_2d_axis_neg2)
{
    Shape shape{2, 4};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, log_softmax_3d_axis_0)
{
    Shape shape{3, 2, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, log_softmax_3d_axis_1)
{
    Shape shape{3, 2, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, log_softmax_3d_axis_2)
{
    Shape shape{3, 2, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, log_softmax_3d_axis_neg1)
{
    Shape shape{3, 2, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, log_softmax_3d_axis_neg2)
{
    Shape shape{3, 2, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, log_softmax_3d_axis_neg3)
{
    Shape shape{3, 2, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape);
