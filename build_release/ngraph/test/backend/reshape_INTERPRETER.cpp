...
NGRAPH_TEST(INTERPRETER, reshape_t2v)
{
    Shape shape_a{2, 2, 3};
...
NGRAPH_TEST(INTERPRETER, reshape_t2s)
{
    Shape shape_a{1, 1, 1};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_r{};
...
NGRAPH_TEST(INTERPRETER, reshape_s2t)
{
    Shape shape_a{};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(INTERPRETER, reshape_s2t1)
{
    Shape shape_a{};
...
NGRAPH_TEST(INTERPRETER, reshape_v2m_col)
{
    Shape shape_a{3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_r{3, 1};
...
NGRAPH_TEST(INTERPRETER, reshape_v2m_row)
{
    Shape shape_a{3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_r{1, 3};
...
NGRAPH_TEST(INTERPRETER, reshape_v2t_middle)
{
    Shape shape_a{3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_r{1, 3, 1};
...
NGRAPH_TEST(INTERPRETER, reshape_m2m_same)
{
    Shape shape_a{3, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_r{3, 3};
...
NGRAPH_TEST(INTERPRETER, reshape_special_zero)
{
...
//
NGRAPH_TEST(INTERPRETER, reshape_6d)
{
...
NGRAPH_TEST(INTERPRETER, builder_reshape_1D_to_scalar)
{
...
NGRAPH_TEST(INTERPRETER, builder_reshape_3D_to_scalar)
{
...
NGRAPH_TEST(INTERPRETER, reshape_shufflenet_5d)
{
