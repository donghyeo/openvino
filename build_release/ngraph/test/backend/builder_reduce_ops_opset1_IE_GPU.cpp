...
NGRAPH_TEST(IE_GPU, builder_opset1_mean)
{
...
NGRAPH_TEST(IE_GPU, builder_opset1_mean_dynamic)
{
...
NGRAPH_TEST(IE_GPU, builder_opset1_mean_dynamic_2)
{
...
NGRAPH_TEST(IE_GPU, builder_opset1_collapse_5d_to_3d)
{
...
NGRAPH_TEST(IE_GPU, builder_opset1_collapse_all_dims)
{
...
NGRAPH_TEST(IE_GPU, builder_opset1_collapse_none)
{
    Shape shape_input{1, 2, 3, 4, 5, 6};
...
NGRAPH_TEST(IE_GPU, builder_opset1_collapse_dyn_shape)
{
