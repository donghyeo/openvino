...
NGRAPH_TEST(INTERPRETER, broadcast_scalar_vector)
{
    Shape shape_a{};
...
NGRAPH_TEST(INTERPRETER, broadcast_scalar_vector_explicit_axis_0)
{
    Shape shape_a{};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_r{1, 2};
...
NGRAPH_TEST(INTERPRETER, broadcast_scalar_matrix)
{
    Shape shape_a{};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_r{2, 2};
...
NGRAPH_TEST(INTERPRETER, broadcast_scalar_tensor)
{
    Shape shape_a{};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_r{2, 2, 2};
...
NGRAPH_TEST(INTERPRETER, broadcast_trivial)
{
    Shape shape{2, 2, 2};
...
NGRAPH_TEST(INTERPRETER, broadcast_vector_colwise)
{
    Shape shape_a{3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_r{3, 4};
...
NGRAPH_TEST(INTERPRETER, broadcast_vector_rowwise)
{
    Shape shape_a{4};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_r{3, 4};
...
NGRAPH_TEST(INTERPRETER, broadcast_vector_rowwise_reversed)
{
    Shape shape_a{4};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_r{3, 4};
...
NGRAPH_TEST(INTERPRETER, broadcast_vector_rowwise_int64)
{
    Shape shape_a{4};
...
NGRAPH_TEST(INTERPRETER, broadcast_scalar_to_matrix_int64)
{
    Shape shape_a{1};
    auto A = make_shared<op::Parameter>(element::i64, shape_a);
    Shape shape_r{3, 1};
...
NGRAPH_TEST(INTERPRETER, broadcast_scalar_to_matrix_int32)
{
    Shape shape_a{1};
...
static void broadcast_test_helper(const Shape& shape_a, const Shape& shape_r, const AxisSet& axes)
{
    ...
    auto wrk_backend = runtime::Backend::create("INTERPRETER");
...
NGRAPH_TEST(INTERPRETER, broadcast_algo_vector_middle)
{
    Shape shape_a{2};
    Shape shape_r{3, 2, 4};
    AxisSet axis{1};
...
NGRAPH_TEST(INTERPRETER, broadcast_algo_vector_forward_2)
{
    Shape shape_a{2};
    Shape shape_r{3, 2};
    AxisSet axis{1};
...
NGRAPH_TEST(INTERPRETER, broadcast_algo_vector_forward_3)
{
    Shape shape_a{2};
    Shape shape_r{4, 3, 2};
    AxisSet axis{2};
...
NGRAPH_TEST(INTERPRETER, broadcast_algo_vector_forward_4)
{
    Shape shape_a{2};
...
NGRAPH_TEST(INTERPRETER, broadcast_algo_scalar)
{
    Shape shape_a{};
    Shape shape_r{5, 4, 3, 2};
    AxisSet axis{};
...
NGRAPH_TEST(INTERPRETER, broadcast_algo_vector_backward_2)
{
    Shape shape_a{2};
    Shape shape_r{2, 3};
    AxisSet axis{0};
...
NGRAPH_TEST(INTERPRETER, broadcast_algo_vector_backward_3)
{
    Shape shape_a{2};
    Shape shape_r{2, 3, 4};
    AxisSet axis{0};
...
NGRAPH_TEST(INTERPRETER, broadcast_algo_vector_backward_4)
{
    Shape shape_a{2};
...
NGRAPH_TEST(INTERPRETER, broadcast_algo_matrix_backward_4)
{
    Shape shape_a{4, 5};
    Shape shape_r{2, 3, 4, 5};
    AxisSet axis{2, 3};
...
NGRAPH_TEST(INTERPRETER, broadcast_algo_matrix_stride_1)
{
    Shape shape_a{3, 5};
    Shape shape_r{2, 3, 4, 5};
    AxisSet axis{1, 3};
...
NGRAPH_TEST(INTERPRETER, broadcast_algo_matrix_stride_2)
{
    Shape shape_a{3, 4};
    Shape shape_r{2, 3, 4, 5};
    AxisSet axis{1, 2};
...
NGRAPH_TEST(INTERPRETER, broadcast_algo_matrix_stride_3)
{
    Shape shape_a{2, 4};
    Shape shape_r{2, 3, 4, 5};
    AxisSet axis{0, 2};
...
NGRAPH_TEST(INTERPRETER, broadcast_algo_3d_backward)
{
    Shape shape_a{2, 3, 4};
...
NGRAPH_TEST(INTERPRETER, broadcast_algo_3d_stride_1)
{
    Shape shape_a{2, 3, 4};
...
NGRAPH_TEST(INTERPRETER, broadcast_algo_3d_stride_2)
{
    Shape shape_a{2, 3, 4};
...
NGRAPH_TEST(INTERPRETER, broadcast_matrix_0)
{
    Shape shape_a{2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_r{2, 2, 2};
...
NGRAPH_TEST(INTERPRETER, broadcast_matrix_1)
{
    Shape shape_a{2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_r{2, 2, 2};
...
NGRAPH_TEST(INTERPRETER, broadcast_matrix_2)
{
    Shape shape_a{2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_r{2, 2, 2};
