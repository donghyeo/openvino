...
NGRAPH_TEST(INTERPRETER, split_1d)
{
...
NGRAPH_TEST(INTERPRETER, split_2d_axis_0)
{
    Shape shape{6, 2};
...
NGRAPH_TEST(INTERPRETER, split_2d_axis_1)
{
    Shape shape{6, 2};
    const auto data = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(INTERPRETER, split_3d_axis_0)
{
    Shape shape{2, 2, 3};
    const auto data = make_shared<op::Parameter>(element::f32, shape);
    const auto axis = op::Constant::create(element::i64, Shape{}, {0});
...
NGRAPH_TEST(INTERPRETER, split_3d_axis_1)
{
    Shape shape{2, 8, 2};
    const auto data = make_shared<op::Parameter>(element::f32, shape);
    const auto axis = op::Constant::create(element::i64, Shape{}, {1});
...
NGRAPH_TEST(INTERPRETER, split_3d_axis_2)
{
    Shape shape{2, 1, 6};
    const auto data = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(INTERPRETER, split_4d_axis_0)
{
    Shape shape{3, 2, 3, 1};
    const auto data = make_shared<op::Parameter>(element::f32, shape);
    const auto axis = op::Constant::create(element::i64, Shape{}, {0});
...
NGRAPH_TEST(INTERPRETER, split_4d_axis_1)
{
    Shape shape{2, 8, 2, 2};
    const auto data = make_shared<op::Parameter>(element::f32, shape);
    const auto axis = op::Constant::create(element::i64, Shape{}, {1});
...
NGRAPH_TEST(INTERPRETER, split_4d_axis_2)
{
    Shape shape{2, 1, 6, 2};
    const auto data = make_shared<op::Parameter>(element::f32, shape);
    const auto axis = op::Constant::create(element::i64, Shape{}, {2});
...
NGRAPH_TEST(INTERPRETER, split_4d_axis_3)
{
    Shape shape{2, 1, 2, 6};
    const auto data = make_shared<op::Parameter>(element::f32, shape);
