...
NGRAPH_TEST(INTERPRETER, numeric_float_nan)
{
    Shape shape{5};
...
NGRAPH_TEST(INTERPRETER, numeric_double_nan)
{
    Shape shape{5};
...
NGRAPH_TEST(INTERPRETER, numeric_float_inf)
{
    Shape shape{5};
...
NGRAPH_TEST(INTERPRETER, numeric_double_inf)
{
    Shape shape{5};
