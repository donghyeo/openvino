...
NGRAPH_TEST(IE_GPU, create_dynamic_backend)
{
...
NGRAPH_TEST(IE_GPU, create_dynamic_tensor)
{
    auto backend = runtime::Backend::create("IE_GPU", true);
...
NGRAPH_TEST(IE_GPU, dynamic_abc)
{
    //
...
NGRAPH_TEST(IE_GPU, dynamic_axpy)
{
    // Test with shape {?, 3, 3}.
...
NGRAPH_TEST(IE_GPU, dynamic_to_vector)
{
    // Test with shape {?, 3, 3}.
...
NGRAPH_TEST(IE_GPU, dynamic_reverse_shape)
{
    // Test with shape {?, 3, 3}.
...
NGRAPH_TEST(IE_GPU, dynamic_transpose)
{
