...
// clang-format off
NGRAPH_TEST(INTERPRETER, group_convolution_1D_1group_1batch_1channel)
{
...
NGRAPH_TEST(INTERPRETER, group_convolution_1D_2group_1batch_2channel)
{
    const Strides strides{1};
    const CoordinateDiff padding{0};
    const Strides dilations{1};
...
NGRAPH_TEST(INTERPRETER, group_convolution_1D_2group_1batch_2_filters_2channel)
{
    const Strides strides{1};
    const CoordinateDiff padding{0};
    const Strides dilations{1};
...
NGRAPH_TEST(INTERPRETER, group_convolution_1D_2group_2batch_2channel)
{
    const Strides strides{1};
    const CoordinateDiff padding{0};
    const Strides dilations{1};
