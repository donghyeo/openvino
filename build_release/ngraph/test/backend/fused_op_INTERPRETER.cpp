...
static string s_manifest = "/home/donghyeon/openvino_andrew/ngraph/test/runtime/interpreter/unit_test.manifest";

using TestEngine = test::ENGINE_CLASS_NAME(INTERPRETER);

NGRAPH_TEST(INTERPRETER, elu)
{
...
NGRAPH_TEST(INTERPRETER, elu_negative_alpha)
{
    auto A = make_shared<op::Parameter>(element::f32, Shape{3, 2});
...
NGRAPH_TEST(INTERPRETER, hardsigmoid)
{
...
NGRAPH_TEST(INTERPRETER, prelu_shared_slope)
{
    Shape shape{3, 2};
    Shape rshape{};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(INTERPRETER, prelu_negative_slope)
{
    Shape shape{3, 2};
    Shape rshape{};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(INTERPRETER, space_to_depth_block_first)
{
...
NGRAPH_TEST(INTERPRETER, space_to_depth_depth_first)
{
    auto A = make_shared<op::Parameter>(element::f32, Shape{1, 2, 4, 4});
...
NGRAPH_TEST(INTERPRETER, depth_to_space_block_first)
{
...
NGRAPH_TEST(INTERPRETER, depth_to_space_depth_first)
{
    auto A = make_shared<op::Parameter>(element::f32, Shape{1, 8, 2, 2});
    auto depth_to_space =
...
// TODO: Issue: 37521
NGRAPH_TEST(INTERPRETER, DISABLED_normalize_across_chw_4d)
{
...
NGRAPH_TEST(INTERPRETER, DISABLED_normalize_across_empty_axes_input)
{
    Shape data_shape{1, 2, 3, 4};
    auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, DISABLED_normalize_across_h_4d)
{
    Shape data_shape{1, 2, 3, 4};
    auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, DISABLED_normalize_across_1axis_5d)
{
...
NGRAPH_TEST(INTERPRETER, DISABLED_normalize_across_123axes_5d)
{
    Shape data_shape{1, 2, 2, 2, 3};
    auto data = make_shared<op::Parameter>(element::f32, data_shape);
    const auto axes = make_shared<op::Constant>(element::i64, Shape{3}, vector<int64_t>{1, 2, 3});
...
NGRAPH_TEST(INTERPRETER, DISABLED_normalize_across_c_2x2_shape)
{
...
NGRAPH_TEST(INTERPRETER, DISABLED_normalize_across_c_2x4_shape)
{
...
NGRAPH_TEST(INTERPRETER, DISABLED_normalize_across_chw_4d_max_bias)
{
    Shape data_shape{1, 2, 3, 4};
    auto data = make_shared<op::Parameter>(element::f32, data_shape);
    const auto axes = make_shared<op::Constant>(element::i64, Shape{3}, vector<int64_t>{1, 2, 3});
...
NGRAPH_TEST(INTERPRETER, fused_clamp_double)
{
...
NGRAPH_TEST(INTERPRETER, fused_clamp_float)
{
...
NGRAPH_TEST(INTERPRETER, fused_clamp_int8)
{
...
NGRAPH_TEST(INTERPRETER, fused_clamp_int16)
{
...
NGRAPH_TEST(INTERPRETER, fused_clamp_int32)
{
...
NGRAPH_TEST(INTERPRETER, fused_clamp_int64)
{
...
NGRAPH_TEST(INTERPRETER, fused_clamp_uint8)
{
...
NGRAPH_TEST(INTERPRETER, fused_clamp_uint16)
{
...
NGRAPH_TEST(INTERPRETER, fused_clamp_uint32)
{
...
NGRAPH_TEST(INTERPRETER, fused_clamp_uint64)
{
...
NGRAPH_TEST(INTERPRETER, fused_clamp_float16)
{
...
NGRAPH_TEST(INTERPRETER, fused_clamp_bfloat16)
{
...
NGRAPH_TEST(INTERPRETER, mvn_mean_normalization)
{
...
NGRAPH_TEST(INTERPRETER, mvn_mean_normalization_split_channels)
{
...
NGRAPH_TEST(INTERPRETER, mvn_mean_variance_normalization)
{
    Shape data_shape{1, 2, 5};
    auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, mvn_mean_variance_normalization_split_channels)
{
    Shape data_shape{1, 2, 5};
    auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, mvn_mean_variance_normalization_shared_across_channel_batch_size_2)
{
...
NGRAPH_TEST(INTERPRETER, mvn_mean_variance_normalization_not_shared_across_channel_batch_size_2)
{
    Shape data_shape{2, 2, 5};
    auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, grn_4d)
{
...
NGRAPH_TEST(INTERPRETER, DISABLED_grn_2d_with_bias)
{
...
NGRAPH_TEST(INTERPRETER, unsqueeze)
{
...
NGRAPH_TEST(INTERPRETER, shuffle_channels_simple)
{
...
NGRAPH_TEST(INTERPRETER, shuffle_channels_negative_axis)
{
...
NGRAPH_TEST(INTERPRETER, shuffle_channels_float)
{
...
NGRAPH_TEST(INTERPRETER, squeeze)
{
...
NGRAPH_TEST(INTERPRETER, squeeze_default_axes)
{
    const auto data_node = make_shared<op::Parameter>(element::f32, Shape{1, 4, 1, 1, 2});
    const auto axes_node =
...
NGRAPH_TEST(INTERPRETER, squeeze_dynamic)
{
...
// TODO: Issue: 37534
NGRAPH_TEST(INTERPRETER, DISABLED_squared_difference)
{
...
NGRAPH_TEST(INTERPRETER, DISABLED_squared_difference_broadcast)
{
...
NGRAPH_TEST(INTERPRETER, lstm_cell__zero_bias_peepholes)
{
...
NGRAPH_TEST(INTERPRETER, DISABLED_lstm_cell__bias_peepholes)
{
    const size_t batch_size = 2;
    const size_t input_size = 3;
    const size_t hidden_size = 3;
...
NGRAPH_TEST(INTERPRETER, DISABLED_lstm_cell__bias_peepholes_clip_input_forget)
{
    const size_t batch_size = 2;
    const size_t input_size = 3;
    const size_t hidden_size = 3;
...
NGRAPH_TEST(INTERPRETER, DISABLED_lstm_cell__activaction_functions)
{
    const size_t batch_size = 2;
    const size_t input_size = 3;
    const size_t hidden_size = 3;
...
// TODO: Issue: 37511
NGRAPH_TEST(INTERPRETER, DISABLED_fake_quantize)
{
    const Shape data_shape{1, 2, 3, 4};
...
NGRAPH_TEST(INTERPRETER, DISABLED_fake_quantize_with_clip)
{
    const Shape data_shape{1, 2, 3, 4};
...
NGRAPH_TEST(INTERPRETER, DISABLED_fake_quantize_with_clip_across_channels)
{
...
NGRAPH_TEST(INTERPRETER, DISABLED_fake_quantize_pdpd)
{
    Shape data_shape{1, 2, 5, 5};
    size_t levels = 5;
    auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, rnn_cell__no_bias)
{
    const size_t batch_size = 2;
    const size_t input_size = 3;
    const size_t hidden_size = 3;
...
NGRAPH_TEST(INTERPRETER, rnn_cell__bias_clip)
{
    const size_t batch_size = 2;
    const size_t input_size = 3;
    const size_t hidden_size = 3;
...
NGRAPH_TEST(INTERPRETER, rnn_cell__activation_function)
{
    const size_t batch_size = 2;
    const size_t input_size = 3;
    const size_t hidden_size = 3;
...
NGRAPH_TEST(INTERPRETER, gru_cell_bias_clip)
{
    const size_t batch_size = 2;
    const size_t input_size = 3;
    const size_t hidden_size = 3;
...
NGRAPH_TEST(INTERPRETER, gru_cell_linear_before_reset)
{
    const size_t batch_size = 2;
    const size_t input_size = 3;
    const size_t hidden_size = 3;
...
NGRAPH_TEST(INTERPRETER, gru_cell_activation_function)
{
    const size_t batch_size = 2;
    const size_t input_size = 3;
    const size_t hidden_size = 3;
...
NGRAPH_TEST(INTERPRETER, depth_to_space_space_to_depth_block_first)
{
...
NGRAPH_TEST(INTERPRETER, depth_to_space_space_to_depth_depth_first)
{
    auto backend = runtime::Backend::create("INTERPRETER");
    Shape dts_input_shape{2, 32, 2, 4, 2, 4};
    size_t block_size = 2;
