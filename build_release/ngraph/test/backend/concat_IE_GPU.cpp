...
NGRAPH_TEST(IE_GPU, concat_negative_axis)
{
...
NGRAPH_TEST(IE_GPU, concat_matrix_colwise)
{
    Shape shape_a{2, 2};
...
NGRAPH_TEST(IE_GPU, concat_matrix_rowwise)
{
    Shape shape_a{2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_b{3, 2};
...
NGRAPH_TEST(IE_GPU, concat_matrix_int64)
{
    Shape shape_a{2, 2};
...
NGRAPH_TEST_P(IE_GPU, concat_vector_params, concat_vector_large)
{
    Shape shape_a{1};
    NodeVector inputs;
...
NGRAPH_INSTANTIATE_TEST_CASE_P(IE_GPU,
                               input_sizes,
                               concat_vector_params,
                               testing::Values(100, 128, 999));

NGRAPH_TEST(IE_GPU, concat_vector)
{
    Shape shape_a{4};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_b{6};
...
NGRAPH_TEST(IE_GPU, concat_4d_tensor)
{
    Shape shape{1, 1, 1, 1};
...
NGRAPH_TEST(IE_GPU, concat_2d_tensor)
{
    Shape shape{1, 1};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto B = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, concat_in_place_2d_tensor)
{
    Shape shape{1, 1};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto B = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, concat_in_place_propagate_2d_tensor)
{
    Shape shape{1, 1};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto B = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, concat_in_place_tree_1)
{
    Shape shape{1, 2, 2};
    Shape shape_r{1, 4, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, concat_in_place_tree_2)
{
    Shape shape{1, 2, 2};
    Shape shape_r{1, 8, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, concat_in_place_tree_3)
{
    Shape shape{1, 2, 2};
...
NGRAPH_TEST(IE_GPU, concat_in_place_add_concat)
{
    Shape shape{2, 2};
    Shape shape_r{4, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, concat_in_place_add_concat_2)
{
    Shape shape{1, 2, 2};
    Shape shape_r{1, 6, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, concat_zero_length_1d_last)
{
    Shape shape_a{4};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_b{0};
...
NGRAPH_TEST(IE_GPU, concat_zero_length_1d_middle)
{
    Shape shape_a{4};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_b{0};
...
NGRAPH_TEST(IE_GPU, concat_zero_zero)
{
    Shape shape{0};
...
NGRAPH_TEST(IE_GPU, concat_zero_length_4d_middle)
{
