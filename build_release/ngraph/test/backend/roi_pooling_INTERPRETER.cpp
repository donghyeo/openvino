...
NGRAPH_TEST(INTERPRETER, roi_pooling_1x1_max)
{
    const int H = 6;
    const int W = 6;
...
NGRAPH_TEST(INTERPRETER, roi_pooling_2x2_max)
{
    const int H = 6;
    const int W = 6;
    const int image_size = H * W;
...
NGRAPH_TEST(INTERPRETER, roi_pooling_1x1_bilinear)
{
    const int H = 6;
    const int W = 6;
    const int image_size = H * W;
...
NGRAPH_TEST(INTERPRETER, roi_pooling_2x2_bilinear)
{
    const int H = 8;
    const int W = 8;
    const int image_size = H * W;
