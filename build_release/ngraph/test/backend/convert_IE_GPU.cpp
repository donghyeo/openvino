...
NGRAPH_TEST(IE_GPU, convert_int32_float32)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(IE_GPU, convert_uint16_float32)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(IE_GPU, convert_int32_bool)
{
    Shape shape{2, 3};
    auto A = make_shared<op::Parameter>(element::i32, shape);
    auto f =
...
NGRAPH_TEST(IE_GPU, convert_float32_bool)
{
    Shape shape{3, 3};
...
NGRAPH_TEST(IE_GPU, convert_float32_bf16)
{
...
NGRAPH_TEST(IE_GPU, convert_bf16_float32)
{
    Shape shape_a{1, 1, 3, 5};
...
NGRAPH_TEST(IE_GPU, convert_fp16_float32)
{
...
NGRAPH_TEST(IE_GPU, convert_uint8_fp16)
{
