...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xngraphx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/deployment_tools/ngraph/lib" TYPE SHARED_LIBRARY FILES "/home/donghyeon/openvino_andrew/bin/intel64/Debug/lib/libngraph.so")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/deployment_tools/ngraph/lib/libngraph.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/deployment_tools/ngraph/lib/libngraph.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/deployment_tools/ngraph/lib/libngraph.so"
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xngraphx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/deployment_tools/ngraph/include/ngraph" TYPE FILE FILES "/home/donghyeon/openvino_andrew/build_debug/ngraph/core/include/ngraph/version.hpp")
endif()

if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  # Include the install script for each subdirectory.
  include("/home/donghyeon/openvino_andrew/build_debug/ngraph/core/builder/cmake_install.cmake")
  include("/home/donghyeon/openvino_andrew/build_debug/ngraph/core/reference/cmake_install.cmake")
