...
NGRAPH_TEST(INTERPRETER, psroi_pooling_average)
{
...
NGRAPH_TEST(INTERPRETER, psroi_pooling_average_spatial_scale)
{
    size_t num_channels = 8;
    size_t group_size = 2;
    size_t output_dim = num_channels / (group_size * group_size);
...
NGRAPH_TEST(INTERPRETER, psroi_pooling_bilinear)
{
...
NGRAPH_TEST(INTERPRETER, psroi_pooling_bilinear_spatial_scale)
{
    size_t num_channels = 12;
    size_t group_size = 4;
    size_t spatial_bins_x = 2;
