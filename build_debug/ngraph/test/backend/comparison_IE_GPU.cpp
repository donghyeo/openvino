...
NGRAPH_TEST(IE_GPU, greater_int64)
{
    Shape shape{2, 2, 2};
...
NGRAPH_TEST(IE_GPU, lesseq_int32)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(IE_GPU, lesseq_bool)
{
    Shape shape{2, 2, 2};
