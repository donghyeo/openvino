...
NGRAPH_TEST(INTERPRETER, tensor_constant)
{
    Shape shape{2, 2, 2};
...
NGRAPH_TEST(INTERPRETER, tensor_2constant)
{
    Shape shape{2, 2, 2};
    auto A = op::Constant::create(element::f32, shape, {1, 2, 3, 4, 5, 6, 7, 8});
...
NGRAPH_TEST(INTERPRETER, tensor_constant_with_op)
{
    Shape shape{2, 2, 2};
    auto A = op::Constant::create(element::f32, shape, {-1, 2, 3, -4, 5, -6, -7, 8});
...
NGRAPH_TEST(INTERPRETER, constant_multi_use)
{
...
NGRAPH_TEST(INTERPRETER, scalar_constant_float32)
{
...
NGRAPH_TEST(INTERPRETER, scalar_constant_int64)
{
...
NGRAPH_TEST(INTERPRETER, tensor_constant_float32)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(INTERPRETER, tensor_constant_int64)
{
    Shape shape{2};
...
NGRAPH_TEST(INTERPRETER, constant_equality_bool)
{
    Shape shape{4};
