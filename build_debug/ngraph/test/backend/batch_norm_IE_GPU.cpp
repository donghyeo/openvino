...
NGRAPH_TEST(IE_GPU, batch_norm_inference_0eps_f64)
{
    using T = double;
    auto& et = element::f64;
...
NGRAPH_TEST(IE_GPU, batch_norm_inference_0eps_f32)
{
    using T = float;
    auto& et = element::f32;
    auto backend = runtime::Backend::create("IE_GPU");
...
NGRAPH_TEST(IE_GPU, batch_norm_inference_f64)
{
    using T = double;
    auto& et = element::f64;
    auto backend = runtime::Backend::create("IE_GPU");
...
NGRAPH_TEST(IE_GPU, batch_norm_inference_f32)
{
    using T = float;
    auto& et = element::f32;
    auto backend = runtime::Backend::create("IE_GPU");
...
NGRAPH_TEST(IE_GPU, batch_norm_inference_parameters_duplication)
{
...
NGRAPH_TEST(IE_GPU, batch_norm_inference_parameters_duplication_v5)
{
    auto input_shape = Shape{2, 2, 2, 1};
    auto input = make_shared<op::Parameter>(element::f32, input_shape);
...
NGRAPH_TEST(IE_GPU, batch_norm_fprop_inference_b2c2h2w1)
{
    auto input_shape = Shape{2, 2, 2, 1};
    auto input = make_shared<op::Parameter>(element::f32, input_shape);
...
NGRAPH_TEST(IE_GPU, batch_norm_fprop_inference_b2c2h2w1_v5)
{
    auto input_shape = Shape{2, 2, 2, 1};
    auto input = make_shared<op::Parameter>(element::f32, input_shape);
    auto gamma_shape = Shape{2};
