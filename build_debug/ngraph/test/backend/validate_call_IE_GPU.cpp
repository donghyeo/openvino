...
NGRAPH_TEST(IE_GPU, validate_call_input_count)
{
...
NGRAPH_TEST(IE_GPU, validate_call_input_type)
{
    auto backend = runtime::Backend::create("IE_GPU");
...
NGRAPH_TEST(IE_GPU, validate_call_input_shape)
{
    auto backend = runtime::Backend::create("IE_GPU");
...
NGRAPH_TEST(IE_GPU, validate_call_output_count)
{
    auto backend = runtime::Backend::create("IE_GPU");
...
NGRAPH_TEST(IE_GPU, validate_call_output_type)
{
    auto backend = runtime::Backend::create("IE_GPU");
...
NGRAPH_TEST(IE_GPU, validate_call_output_shape)
{
    auto backend = runtime::Backend::create("IE_GPU");
