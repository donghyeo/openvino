...
NGRAPH_TEST(INTERPRETER, auto_bcast_binary_elementwise_pdpd_dynamic)
{
...
NGRAPH_TEST(INTERPRETER, auto_bcast_string_cast)
{
...
NGRAPH_TEST(INTERPRETER, auto_bcast_string_cast_lowercase_attrs)
{
    auto a = make_shared<op::Parameter>(element::f32, Shape{1});
    auto b = make_shared<op::Parameter>(element::f32, Shape{1});
