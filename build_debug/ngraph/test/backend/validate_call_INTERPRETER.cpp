...
NGRAPH_TEST(INTERPRETER, validate_call_input_count)
{
...
NGRAPH_TEST(INTERPRETER, validate_call_input_type)
{
    auto backend = runtime::Backend::create("INTERPRETER");
...
NGRAPH_TEST(INTERPRETER, validate_call_input_shape)
{
    auto backend = runtime::Backend::create("INTERPRETER");
...
NGRAPH_TEST(INTERPRETER, validate_call_output_count)
{
    auto backend = runtime::Backend::create("INTERPRETER");
...
NGRAPH_TEST(INTERPRETER, validate_call_output_type)
{
    auto backend = runtime::Backend::create("INTERPRETER");
...
NGRAPH_TEST(INTERPRETER, validate_call_output_shape)
{
    auto backend = runtime::Backend::create("INTERPRETER");
