...
NGRAPH_TEST(INTERPRETER, reduce_sum_to_scalar)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_large_1d_to_scalar)
{
    Shape shape{1000000};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(INTERPRETER, reduce_sum_matrix_columns)
{
    Shape shape_a{3, 2};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_matrix_6d)
{
    ...
    auto backend_wrk = runtime::Backend::create("INTERPRETER");
...
NGRAPH_TEST(INTERPRETER, reduce_sum_matrix_rows)
{
    Shape shape_a{3, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{3};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_matrix_rows_zero)
{
    Shape shape_a{3, 0};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{3};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_matrix_cols_zero)
{
...
NGRAPH_TEST(INTERPRETER, reduce_sum_vector_zero)
{
    Shape shape_a{0};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_matrix_to_scalar_zero_by_zero)
{
    Shape shape_a{0, 0};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_3d_to_matrix_most_sig)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{3, 3};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_3d_to_matrix_least_sig)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{3, 3};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_3d_to_vector)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{3};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_3d_to_scalar)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_3d_to_scalar_int32)
{
    Shape shape_a{3, 3, 3};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_3d_eliminate_zero_dim)
{
    Shape shape_a{3, 0, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{3, 2};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_3d_eliminate_zero_dim_int32)
{
    Shape shape_a{3, 0, 2};
    auto A = make_shared<op::Parameter>(element::i32, shape_a);
    Shape shape_rt{3, 2};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_5d_to_scalar)
{
...
NGRAPH_TEST(INTERPRETER, reduce_sum_5d_to_scalar_int32)
{
    Shape shape_a{3, 3, 3, 3, 3};
    auto A = make_shared<op::Parameter>(element::i32, shape_a);
    Shape shape_rt{};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_2d_to_scalar_int8)
{
    Shape shape_a{3, 3};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_trivial_in_double)
{
    Shape shape{4, 3};
    Shape rshape{3};
...
#ifndef _WIN32
NGRAPH_TEST(INTERPRETER, reduce_sum_stable_acc)
{
    std::string backend_name = "INTERPRETER";
...
NGRAPH_TEST(INTERPRETER, reduce_sum_stable_acc_double)
{
    std::string backend_name = "INTERPRETER";
    if (backend_name == "INTERPRETER")
    {
...
NGRAPH_TEST(INTERPRETER, reduce_sum_stable_simple_float)
{
    std::string backend_name = "INTERPRETER";
    if (backend_name == "INTERPRETER")
    {
...
#ifndef _WIN32
NGRAPH_TEST(INTERPRETER, reduce_sum_stable_simple_double)
{
    std::string backend_name = "INTERPRETER";
    if (backend_name == "INTERPRETER")
    {
...
NGRAPH_TEST(INTERPRETER, reduce_sum_dynamic)
{
...
NGRAPH_TEST(INTERPRETER, reduce_sum_inf)
{
    Shape shape{7, 4};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto axes = make_shared<op::Constant>(element::i32, Shape{}, 1);
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_to_scalar)
{
    Shape shape{2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto axes = make_shared<op::Constant>(element::i32, Shape{2}, vector<int32_t>{0, 1});
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_large_1d_to_scalar)
{
    Shape shape{1000000};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto axes = make_shared<op::Constant>(element::i32, Shape{}, 0);
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_matrix_columns)
{
    Shape shape_a{3, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{1, 2};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_matrix_6d)
{
    Shape shape_a{2, 6, 4, 5, 7, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_matrix_rows)
{
    Shape shape_a{3, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{3, 1};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_matrix_rows_zero)
{
    Shape shape_a{3, 0};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{3, 1};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_matrix_cols_zero)
{
    // Now the reduction (g(x:float32[2,2],y:float32[]) = reduce(x,y,f,axes={})).
    Shape shape_a{0, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_vector_zero)
{
    Shape shape_a{0};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{1};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_matrix_to_scalar_zero_by_zero)
{
    Shape shape_a{0, 0};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{1, 1};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_3d_to_matrix_most_sig)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_3d_to_matrix_least_sig)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_3d_to_vector)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_3d_to_scalar)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_3d_to_scalar_int32)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::i32, shape_a);
    Shape shape_rt{1, 1, 1};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_3d_eliminate_zero_dim)
{
    Shape shape_a{3, 0, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_3d_eliminate_zero_dim_int32)
{
    Shape shape_a{3, 0, 2};
    auto A = make_shared<op::Parameter>(element::i32, shape_a);
    Shape shape_rt{3, 1, 2};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_5d_to_scalar)
{
    Shape shape_a{3, 3, 3, 3, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_5d_to_scalar_int32)
{
    Shape shape_a{3, 3, 3, 3, 3};
    auto A = make_shared<op::Parameter>(element::i32, shape_a);
    Shape shape_rt{1, 1, 1, 1, 1};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_2d_to_scalar_int8)
{
    Shape shape_a{3, 3};
    auto A = make_shared<op::Parameter>(element::i8, shape_a);
    Shape shape_rt{1, 1};
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_trivial_in_double)
{
    Shape shape{4, 3};
    Shape rshape{1, 3};
    auto A = make_shared<op::Parameter>(element::f64, shape);
...
#ifndef _WIN32
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_stable_acc)
{
    std::string backend_name = "INTERPRETER";
    if (backend_name == "INTERPRETER")
    {
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_stable_acc_double)
{
    std::string backend_name = "INTERPRETER";
    if (backend_name == "INTERPRETER")
    {
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_stable_simple_float)
{
    std::string backend_name = "INTERPRETER";
    if (backend_name == "INTERPRETER")
    {
...
#ifndef _WIN32
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_stable_simple_double)
{
    std::string backend_name = "INTERPRETER";
    if (backend_name == "INTERPRETER")
    {
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_dynamic)
{
    // Create a graph for f(x,axes:int32) = Sum(x,Convert<int64>(axes)).
    auto x = make_shared<op::Parameter>(element::f32, PartialShape::dynamic());
    auto axes = make_shared<op::Parameter>(element::i32, PartialShape{Dimension::dynamic()});
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_inf)
{
    Shape shape{7, 4};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto axes = make_shared<op::Constant>(element::i32, Shape{}, 1);
...
NGRAPH_TEST(INTERPRETER, reduce_sum_matrix_columns_dynamic)
{
...
NGRAPH_TEST(INTERPRETER, reduce_sum_matrix_rows_dynamic)
{
    auto A = make_shared<op::Parameter>(element::f32, PartialShape::dynamic());
    auto axes = make_shared<op::Constant>(element::i32, Shape{}, 1);
    auto f =
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_matrix_columns_dynamic)
{
    auto A = make_shared<op::Parameter>(element::f32, PartialShape::dynamic());
    auto axes = make_shared<op::Constant>(element::i32, Shape{}, 0);
    auto f =
...
NGRAPH_TEST(INTERPRETER, reduce_sum_keep_matrix_rows_dynamic)
{
    auto A = make_shared<op::Parameter>(element::f32, PartialShape::dynamic());
    auto axes = make_shared<op::Constant>(element::i32, Shape{}, 1);
    auto f =
