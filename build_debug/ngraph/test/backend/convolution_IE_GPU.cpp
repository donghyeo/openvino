...
// --------------------- 1D convolution ------------------------------------------
// clang-format off
NGRAPH_TEST(IE_GPU, convolution_1D_1batch_1channel)
{
...
NGRAPH_TEST(IE_GPU, convolution_1D_1batch_1channel_padding)
{
    const Strides strides{1};
...
NGRAPH_TEST(IE_GPU, convolution_1D_1batch_1channel_stride)
{
...
NGRAPH_TEST(IE_GPU, convolution_1D_1batch_1channel_dilation)
{
    const Strides strides{1};
    const CoordinateDiff padding{0};
...
NGRAPH_TEST(IE_GPU, convolution_1D_1batch_1channel_padding_stride_dilation)
{
    const Strides strides{2};
...
NGRAPH_TEST(IE_GPU, convolution_1D_1batch_2channel)
{
    const Strides strides{1};
    const CoordinateDiff padding{0};
    const Strides dilations{1};
...
NGRAPH_TEST(IE_GPU, convolution_1D_1batch_2filter)
{
    const Strides strides{1};
    const CoordinateDiff padding{0};
    const Strides dilations{1};
...
NGRAPH_TEST(IE_GPU, convolution_1D_2batch_1channel)
{
    const Strides strides{1};
    const CoordinateDiff padding{0};
    const Strides dilations{1};
...
// --------------------- 2D convolution ------------------------------------------
NGRAPH_TEST(IE_GPU, convolution_2D_1batch_1channel)
{
...
NGRAPH_TEST(IE_GPU, convolution_2D_1batch_1channel_padding)
{
    const Strides strides{1, 1};
...
NGRAPH_TEST(IE_GPU, convolution_2D_1batch_1channel_stride)
{
...
NGRAPH_TEST(IE_GPU, convolution_2D_1batch_1channel_dilation)
{
    const Strides strides{1, 1};
    const CoordinateDiff padding{0, 0};
...
NGRAPH_TEST(IE_GPU, convolution_2D_1batch_1channel_padding_strides_dilation)
{
    const Strides strides{2, 2};
...
NGRAPH_TEST(IE_GPU, convolution_2D_1batch_2channel)
{
    const Strides strides{1, 1};
    const CoordinateDiff padding{0, 0};
    const Strides dilations{1, 1};
...
NGRAPH_TEST(IE_GPU, convolution_2D_1batch_2filter)
{
    const Strides strides{1, 1};
    const CoordinateDiff padding{0, 0};
    const Strides dilations{1, 1};
...
NGRAPH_TEST(IE_GPU, convolution_2D_2batch_1channel)
{
    const Strides strides{1, 1};
    const CoordinateDiff padding{0, 0};
    const Strides dilations{1, 1};
...
// --------------------- 3D convolution ------------------------------------------
NGRAPH_TEST(IE_GPU, convolution_3D_1batch_1channel)
{
...
NGRAPH_TEST(IE_GPU, convolution_3D_1batch_1channel_padding)
{
    const Strides strides{1, 1, 1};
...
NGRAPH_TEST(IE_GPU, convolution_3D_1batch_1channel_stride)
{
...
NGRAPH_TEST(IE_GPU, convolution_3D_1batch_1channel_padding_strides_dilation)
{
    const Strides strides{2, 2, 2};
...
NGRAPH_TEST(IE_GPU, convolution_3D_1batch_2channel)
{
    const Strides strides{1, 1, 1};
    const CoordinateDiff padding{0, 0, 0};
    const Strides dilations{1, 1, 1};
...
NGRAPH_TEST(IE_GPU, convolution_3D_1batch_2filter)
{
    const Strides strides{1, 1, 1};
    const CoordinateDiff padding{0, 0, 0};
    const Strides dilations{1, 1, 1};
...
NGRAPH_TEST(IE_GPU, convolution_3D_2batch_1channel)
{
    const Strides strides{1, 1, 1};
    const CoordinateDiff padding{0, 0, 0};
    const Strides dilations{1, 1, 1};
...
// ----------------------  other tests ------------------------------------------
// clang-format on
NGRAPH_TEST(IE_GPU, convolution_outlining)
{
...
NGRAPH_TEST(IE_GPU, convolution_simple)
{
    Shape shape_a{1, 2, 2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_b{2, 2, 1, 1};
...
NGRAPH_TEST(IE_GPU, convolution_simple_padding)
{
...
NGRAPH_TEST(IE_GPU, dyn_convolution_backprop_data)
{
