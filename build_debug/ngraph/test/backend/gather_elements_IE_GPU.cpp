...
NGRAPH_TEST(IE_GPU, evaluate_1D_gather_elements_3_indices_int32)
{
...
NGRAPH_TEST(IE_GPU, evaluate_2D_gather_elements_2x2_indices_int32_axis_0)
{
...
NGRAPH_TEST(IE_GPU, evaluate_2D_gather_elements_2x2_indices_int32_axis_1)
{
    auto arg1 = make_shared<op::Parameter>(element::i32, PartialShape{2, 2});
    auto arg2 = make_shared<op::Parameter>(element::i32, PartialShape{2, 2});
    int64_t axis = 1;
...
NGRAPH_TEST(IE_GPU, evaluate_2D_gather_elements_2x2_indices_int32_axis_minus_1)
{
    auto arg1 = make_shared<op::Parameter>(element::i32, PartialShape{2, 2});
    auto arg2 = make_shared<op::Parameter>(element::i32, PartialShape{2, 2});
    int64_t axis = -1;
...
NGRAPH_TEST(IE_GPU, evaluate_2D_gather_elements_2x3_indices_int32)
{
...
NGRAPH_TEST(IE_GPU, evaluate_3D_gather_elements_3x2x2_indices_int32)
{
...
NGRAPH_TEST(IE_GPU, evaluate_4D_gather_elements_3x2x2x2_indices_int64)
{
...
NGRAPH_TEST(IE_GPU, evaluate_3D_gather_elements_3x2x2_indices_int64)
{
    auto arg1 = make_shared<op::Parameter>(element::i32, PartialShape{3, 2, 2});
...
NGRAPH_TEST(IE_GPU, evaluate_2D_gather_elements_3x2_data_bool)
{
...
NGRAPH_TEST(IE_GPU, evaluate_2D_gather_elements_2x3_data_float32)
{
...
NGRAPH_TEST(IE_GPU, evaluate_2D_gather_elements_2x2x1_data_float32)
{
...
NGRAPH_TEST(IE_GPU, evaluate_1D_gather_elements_negative_test)
{
    auto arg1 = make_shared<op::Parameter>(element::i32, PartialShape{3});
    auto arg2 = make_shared<op::Parameter>(element::i32, PartialShape{7});
    int64_t axis = 0;
...
NGRAPH_TEST(IE_GPU, evaluate_2D_gather_elements_negative_test)
{
    auto arg1 = make_shared<op::Parameter>(element::i32, PartialShape{3, 3});
    auto arg2 = make_shared<op::Parameter>(element::i32, PartialShape{2, 3});
    int64_t axis = 0;
