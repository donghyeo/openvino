...
NGRAPH_TEST(INTERPRETER, notequal)
{
    Shape shape{2, 2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto B = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(INTERPRETER, greater)
{
    Shape shape{2, 2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto B = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(INTERPRETER, greater_int64)
{
    Shape shape{2, 2, 2};
...
NGRAPH_TEST(INTERPRETER, greatereq)
{
    Shape shape{2, 2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto B = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(INTERPRETER, lesseq)
{
    Shape shape{2, 2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto B = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(INTERPRETER, lesseq_int32)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(INTERPRETER, lesseq_bool)
{
    Shape shape{2, 2, 2};
