...
NGRAPH_TEST(IE_GPU, divide_int32)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(IE_GPU, divide_cpp_rounding_int32)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(IE_GPU, divide_python_rounding_int32)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(IE_GPU, divide_overload)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(IE_GPU, divide_by_zero_float32)
{
    Shape shape{2, 2};
