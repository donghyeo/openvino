...
NGRAPH_TEST(INTERPRETER, convert_like_float32_int32)
{
...
NGRAPH_TEST(INTERPRETER, convert_like_int32_float32)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(INTERPRETER, convert_like_uint16_float32)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(INTERPRETER, convert_like_int32_bool)
{
    Shape shape{2, 3};
    const auto data = make_shared<op::Parameter>(element::i32, shape);
...
NGRAPH_TEST(INTERPRETER, convert_like_float32_bool)
{
    Shape shape{3, 3};
...
NGRAPH_TEST(INTERPRETER, convert_like_float32_bfloat16)
{
    Shape shape{1, 1, 3, 5};
    const auto data = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(INTERPRETER, convert_like_bfloat16_float32)
{
...
NGRAPH_TEST(INTERPRETER, convert_like_dyn_float16_to_int64)
{
