...
NGRAPH_TEST(INTERPRETER, relu_2Dfprop)
{
...
NGRAPH_TEST(INTERPRETER, relu_2Dfprop_i32)
{
    auto shape_a = Shape{2, 5};
...
NGRAPH_TEST(INTERPRETER, relu_4Dfprop)
{
...
NGRAPH_TEST(INTERPRETER, fuse_max_with_constant_zero_input_as_relu)
{
    auto shape_a = Shape{2, 5};
