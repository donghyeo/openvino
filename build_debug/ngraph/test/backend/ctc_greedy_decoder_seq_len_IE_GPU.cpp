...
NGRAPH_TEST(IE_GPU, evaluate_ctc_greedy_decoder_seq_len)
{
    const int N = 1;
    const int T = 3;
    const int C = 3;
...
NGRAPH_TEST(IE_GPU, evaluate_ctc_greedy_decoder_seq_len_merge)
{
    const int N = 1;
    const int T = 3;
    const int C = 3;
...
NGRAPH_TEST(IE_GPU, evaluate_ctc_greedy_decoder_seq_len_f16)
{
    const int N = 1;
    const int T = 3;
    const int C = 3;
...
NGRAPH_TEST(IE_GPU, evaluate_ctc_greedy_decoder_seq_len_multiple_batches)
{
    const int N = 2;
    const int T = 3;
    const int C = 3;
...
NGRAPH_TEST(IE_GPU, evaluate_ctc_greedy_decoder_seq_len_multiple_batches2)
{
    const int N = 3;
    const int T = 3;
    const int C = 3;
