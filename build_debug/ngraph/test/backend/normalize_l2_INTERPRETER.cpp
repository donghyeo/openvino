...
NGRAPH_TEST(INTERPRETER, normalize_l2_all_mode_add)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(INTERPRETER, normalize_l2_none_mode_add)
{
    Shape shape{2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(INTERPRETER, normalize_l2_zero_mode_add)
{
    Shape shape{2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(INTERPRETER, normalize_l2_one_mode_add)
{
    Shape shape{2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(INTERPRETER, normalize_l2_all_mode_max)
{
    Shape shape{2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto axes = make_shared<op::Constant>(element::i64, Shape{2}, vector<int64_t>{0, 1});
...
NGRAPH_TEST(INTERPRETER, normalize_l2_none_mode_max)
{
    Shape shape{2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto axes = make_shared<op::Constant>(element::i64, Shape{0}, vector<int64_t>{});
...
NGRAPH_TEST(INTERPRETER, normalize_l2_zero_mode_max)
{
    Shape shape{2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto axes = make_shared<op::Constant>(element::i64, Shape{}, vector<int64_t>{0});
...
NGRAPH_TEST(INTERPRETER, normalize_l2_one_mode_max)
{
    Shape shape{2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto axes = make_shared<op::Constant>(element::i64, Shape{}, vector<int64_t>{1});
