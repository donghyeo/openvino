...
NGRAPH_TEST(IE_GPU, detection_output_3_inputs)
{
...
NGRAPH_TEST(IE_GPU, detection_output_3_inputs_share_location)
{
    op::DetectionOutputAttrs attrs;
    attrs.num_classes = 3;
    attrs.background_label_id = -1;
...
NGRAPH_TEST(IE_GPU, detection_output_3_inputs_normalized)
{
    op::DetectionOutputAttrs attrs;
    attrs.num_classes = 3;
    attrs.background_label_id = -1;
...
NGRAPH_TEST(IE_GPU, detection_output_3_inputs_keep_all_bboxes)
{
    op::DetectionOutputAttrs attrs;
    attrs.num_classes = 2;
    attrs.background_label_id = -1;
...
NGRAPH_TEST(IE_GPU, detection_output_3_inputs_center_size)
{
    op::DetectionOutputAttrs attrs;
    attrs.num_classes = 3;
    attrs.background_label_id = -1;
...
NGRAPH_TEST(IE_GPU, detection_output_5_inputs)
{
    op::DetectionOutputAttrs attrs;
    attrs.num_classes = 2;
    attrs.background_label_id = -1;
