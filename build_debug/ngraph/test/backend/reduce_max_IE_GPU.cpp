...
NGRAPH_TEST(IE_GPU, reduce_max_to_scalar)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(IE_GPU, reduce_max_to_scalar_int8)
{
    Shape shape{2, 2};
...
NGRAPH_TEST(IE_GPU, reduce_max_matrix_columns)
{
    Shape shape_a{3, 2};
...
NGRAPH_TEST(IE_GPU, reduce_max_matrix_rows)
{
    Shape shape_a{3, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{3};
...
NGRAPH_TEST(IE_GPU, reduce_max_matrix_rows_int32)
{
    Shape shape_a{3, 2};
...
NGRAPH_TEST(IE_GPU, reduce_max_matrix_rows_zero)
{
    Shape shape_a{3, 0};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{3};
...
NGRAPH_TEST(IE_GPU, reduce_max_matrix_rows_zero_int32)
{
    Shape shape_a{3, 0};
    auto A = make_shared<op::Parameter>(element::i32, shape_a);
    Shape shape_rt{3};
...
NGRAPH_TEST(IE_GPU, reduce_max_matrix_cols_zero)
{
...
NGRAPH_TEST(IE_GPU, reduce_max_vector_zero)
{
    Shape shape_a{0};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{};
...
NGRAPH_TEST(IE_GPU, reduce_max_matrix_to_scalar_zero_by_zero)
{
    Shape shape_a{0, 0};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{};
...
NGRAPH_TEST(IE_GPU, reduce_max_3d_to_matrix_most_sig)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{3, 3};
...
NGRAPH_TEST(IE_GPU, reduce_max_3d_to_matrix_least_sig)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{3, 3};
...
NGRAPH_TEST(IE_GPU, reduce_max_3d_to_vector)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{3};
...
NGRAPH_TEST(IE_GPU, reduce_max_3d_to_scalar)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{};
...
NGRAPH_TEST(IE_GPU, reduce_max_3d_to_scalar_int32)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::i32, shape_a);
    Shape shape_rt{};
...
NGRAPH_TEST(IE_GPU, reduce_max_3d_to_scalar_double)
{
    Shape shape_a{3, 3, 3};
...
NGRAPH_TEST(IE_GPU, reduce_max_3d_eliminate_zero_dim)
{
    Shape shape_a{3, 0, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{3, 2};
...
NGRAPH_TEST(IE_GPU, reduce_max_keep_to_scalar)
{
    Shape shape{2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto axes = make_shared<op::Constant>(element::i32, Shape{2}, vector<int32_t>{0, 1});
...
NGRAPH_TEST(IE_GPU, reduce_max_keep_to_scalar_int8)
{
    Shape shape{2, 2};
    auto A = make_shared<op::Parameter>(element::i8, shape);
    auto axes = make_shared<op::Constant>(element::i32, Shape{2}, vector<int32_t>{0, 1});
...
NGRAPH_TEST(IE_GPU, reduce_max_keep_matrix_columns)
{
    Shape shape_a{3, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{1, 2};
...
NGRAPH_TEST(IE_GPU, reduce_max_keep_matrix_rows)
{
    Shape shape_a{3, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{3, 1};
...
NGRAPH_TEST(IE_GPU, reduce_max_keep_matrix_rows_int32)
{
    Shape shape_a{3, 2};
    auto A = make_shared<op::Parameter>(element::i32, shape_a);
    Shape shape_rt{3, 1};
...
NGRAPH_TEST(IE_GPU, reduce_max_keep_matrix_rows_zero)
{
    Shape shape_a{3, 0};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{3, 1};
...
NGRAPH_TEST(IE_GPU, reduce_max_keep_matrix_rows_zero_int32)
{
    Shape shape_a{3, 0};
    auto A = make_shared<op::Parameter>(element::i32, shape_a);
    Shape shape_rt{3, 1};
...
NGRAPH_TEST(IE_GPU, reduce_max_keep_matrix_cols_zero)
{
    // Now the reduction (g(x:float32[2,2],y:float32[]) = reduce(x,y,f,axes={})).
    Shape shape_a{0, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(IE_GPU, reduce_max_keep_vector_zero)
{
    Shape shape_a{0};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{1};
...
NGRAPH_TEST(IE_GPU, reduce_max_keep_matrix_to_scalar_zero_by_zero)
{
    Shape shape_a{0, 0};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
    Shape shape_rt{1, 1};
...
NGRAPH_TEST(IE_GPU, reduce_max_keep_3d_to_matrix_most_sig)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(IE_GPU, reduce_max_keep_3d_to_matrix_least_sig)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(IE_GPU, reduce_max_keep_3d_to_vector)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(IE_GPU, reduce_max_keep_3d_to_scalar)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(IE_GPU, reduce_max_keep_3d_to_scalar_int32)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::i32, shape_a);
    Shape shape_rt{1, 1, 1};
...
NGRAPH_TEST(IE_GPU, reduce_max_keep_3d_to_scalar_double)
{
    Shape shape_a{3, 3, 3};
    auto A = make_shared<op::Parameter>(element::f64, shape_a);
    Shape shape_rt{1, 1, 1};
...
NGRAPH_TEST(IE_GPU, reduce_max_keep_3d_eliminate_zero_dim)
{
    Shape shape_a{3, 0, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape_a);
...
NGRAPH_TEST(IE_GPU, reduce_max_matrix_columns_dynamic)
{
...
NGRAPH_TEST(IE_GPU, reduce_max_matrix_rows_dynamic)
{
    auto A = make_shared<op::Parameter>(element::f32, PartialShape::dynamic());
    auto axes = make_shared<op::Constant>(element::i32, Shape{}, 1);
    auto f =
...
NGRAPH_TEST(IE_GPU, reduce_max_keep_matrix_columns_dynamic)
{
    auto A = make_shared<op::Parameter>(element::f32, PartialShape::dynamic());
    auto axes = make_shared<op::Constant>(element::i32, Shape{}, 0);
    auto f =
...
NGRAPH_TEST(IE_GPU, reduce_max_keep_matrix_rows_dynamic)
{
    auto A = make_shared<op::Parameter>(element::f32, PartialShape::dynamic());
    auto axes = make_shared<op::Constant>(element::i32, Shape{}, 1);
    auto f =
