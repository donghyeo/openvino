...
NGRAPH_TEST(IE_GPU, softmax_axis_3d)
{
    Shape shape{2, 2, 3};
...
NGRAPH_TEST(IE_GPU, softmax_axis_3d_double)
{
    Shape shape{2, 2, 3};
...
NGRAPH_TEST(IE_GPU, softmax_2d_axis_1)
{
    Shape shape{2, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, softmax_2d_axis_0)
{
    Shape shape{2, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto f = make_shared<Function>(make_shared<op::v1::Softmax>(A, 0), ParameterVector{A});
...
NGRAPH_TEST(IE_GPU, softmax_axis_3d_trivial)
{
    Shape shape{1, 2, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto f = make_shared<Function>(make_shared<op::v1::Softmax>(A, 0), ParameterVector{A});
...
NGRAPH_TEST(IE_GPU, softmax_underflow)
{
    Shape shape{2, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto f = make_shared<Function>(make_shared<op::v1::Softmax>(A, 0), ParameterVector{A});
...
NGRAPH_TEST(IE_GPU, softmax_overflow)
{
    Shape shape{2, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    auto f = make_shared<Function>(make_shared<op::v1::Softmax>(A, 0), ParameterVector{A});
