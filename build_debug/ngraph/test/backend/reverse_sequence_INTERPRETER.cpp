...
NGRAPH_TEST(INTERPRETER, reverse_sequence_n2c3h4w2)
{
    Shape shape{2, 3, 4, 2};
...
NGRAPH_TEST(INTERPRETER, reverse_sequence_n4c3h2w2)
{
    Shape shape{4, 3, 2, 2};
    auto A = make_shared<op::Parameter>(element::i32, shape);
    Shape seq_len_shape{4};
...
NGRAPH_TEST(INTERPRETER, reverse_sequence_n4d2c3h2w2)
{
...
NGRAPH_TEST(INTERPRETER, reverse_sequence_negative_axes)
{
    Shape shape{2, 3, 4, 2};
    Shape seq_len_shape{4};
    auto A = make_shared<op::Parameter>(element::i32, shape);
