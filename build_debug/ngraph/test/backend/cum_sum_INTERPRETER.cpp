...
NGRAPH_TEST(INTERPRETER, cum_sum_default)
{
    Shape shape{1, 4};
...
NGRAPH_TEST(INTERPRETER, cum_sum_2dim)
{
    Shape shape{2, 4};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(INTERPRETER, cum_sum_2dim_default_axis)
{
    Shape shape{2, 4};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(INTERPRETER, cum_sum_3d)
{
...
NGRAPH_TEST(INTERPRETER, cum_sum_2dim_allmodes)
{
