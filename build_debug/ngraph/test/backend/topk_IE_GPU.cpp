...
NGRAPH_TEST(IE_GPU, topk_resnet50)
{
...
NGRAPH_TEST(IE_GPU, topk_max_sort_none)
{
    Shape shape{128, 1000};
    Shape rshape{128, 5};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_min_sort_none)
{
    Shape shape{128, 1000};
    Shape rshape{128, 5};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_max_sort_value)
{
    Shape shape{128, 1000};
    Shape rshape{128, 5};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_min_sort_value)
{
    Shape shape{128, 1000};
    Shape rshape{128, 5};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_max_sort_index)
{
    Shape shape{128, 1000};
    Shape rshape{128, 5};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_min_sort_index)
{
    Shape shape{128, 1000};
    Shape rshape{128, 5};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_1d_max_all)
{
    Shape shape{6};
    Shape rshape{6};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_1d_i32_max_all)
{
    Shape shape{6};
    Shape rshape{6};
...
NGRAPH_TEST(IE_GPU, topk_1d_max_partial)
{
    Shape shape{6};
    Shape rshape{3};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_1d_max_one)
{
    Shape shape{6};
    Shape rshape{1};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_1d_min_all)
{
    Shape shape{6};
    Shape rshape{6};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_1d_min_partial)
{
    Shape shape{6};
    Shape rshape{3};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_1d_min_one)
{
    Shape shape{6};
    Shape rshape{1};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_3d_max_all)
{
    Shape shape{2, 3, 2};
    Shape rshape{2, 3, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_5d_max_partial)
{
...
NGRAPH_TEST(IE_GPU, topk_3d_max_partial)
{
    Shape shape{2, 3, 2};
    Shape rshape{2, 2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_3d_max_one)
{
    Shape shape{2, 3, 2};
    Shape rshape{2, 1, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_3d_min_all)
{
    Shape shape{2, 3, 2};
    Shape rshape{2, 3, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_3d_min_partial)
{
    Shape shape{2, 3, 2};
    Shape rshape{2, 2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_3d_min_one)
{
    Shape shape{2, 3, 2};
    Shape rshape{2, 1, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_2d_max_all)
{
    Shape shape{4, 3};
    Shape rshape{4, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_2d_max_partial)
{
    Shape shape{4, 3};
    Shape rshape{2, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_2d_max_one)
{
    Shape shape{4, 3};
    Shape rshape{1, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_2d_max_one_with_equal_values)
{
    Shape shape{2, 4};
    Shape rshape{2, 1};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_2d_min_all)
{
    Shape shape{4, 3};
    Shape rshape{4, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_2d_min_partial)
{
    Shape shape{4, 3};
    Shape rshape{2, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_2d_min_one)
{
    Shape shape{4, 3};
    Shape rshape{1, 3};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_3d_large_input_max)
{
    ...
    auto gpu_results_0 = execute<float>(gpu_f_0, args, "IE_GPU");
    ...
    auto gpu_results_1 = execute<float, int32_t>(gpu_f_1, args, "IE_GPU");
...
NGRAPH_TEST(IE_GPU, topk_3d_large_input_min)
{
    Shape shape{4, 8192, 5};
    auto A = make_shared<op::Parameter>(element::f32, shape);
    ...
    auto gpu_results_0 = execute(gpu_f_0, args, "IE_GPU");
    for (size_t i = 0; i < gpu_results_0.size(); i++)
    {
        EXPECT_TRUE(test::all_close_f(
            gpu_results_0.at(i), interp_results_0.at(i), MIN_FLOAT_TOLERANCE_BITS));
...
NGRAPH_TEST(IE_GPU, topk_3d_single_output)
{
    Shape shape{2, 3, 2};
    Shape rshape{2, 2, 2};
    auto A = make_shared<op::Parameter>(element::f32, shape);
...
NGRAPH_TEST(IE_GPU, topk_v1_invalid_strings)
{
...
NGRAPH_TEST(IE_GPU, topk_v1_invalid_k)
{
    const auto data = make_shared<op::Parameter>(element::f32, Shape{1, 2, 3});
...
INSTANTIATE_TYPED_TEST_CASE_P(IE_GPU, topk_backend, TopKTypes);
