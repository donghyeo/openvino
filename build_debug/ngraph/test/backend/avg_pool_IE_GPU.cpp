...
NGRAPH_TEST(IE_GPU, avg_pool_2d_floor)
{
...
NGRAPH_TEST(IE_GPU, avg_pool_2d_ceil)
{
...
NGRAPH_TEST(IE_GPU, avg_pool_2d_pad)
{
...
NGRAPH_TEST(IE_GPU, avg_pool_2d_same_upper)
{
    Shape in_shape{1, 1, 3, 3};
    Shape out_shape{1, 1, 3, 3};
    const Strides& strides{1, 1};
...
NGRAPH_TEST(IE_GPU, avg_pool_3d)
{
...
NGRAPH_TEST(IE_GPU, avg_pool_2d_same_lower)
{
    Shape in_shape{1, 1, 3, 3};
    Shape out_shape{1, 1, 3, 3};
    const Strides& strides{1, 1};
