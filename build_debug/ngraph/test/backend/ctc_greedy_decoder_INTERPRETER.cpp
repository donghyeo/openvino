...
NGRAPH_TEST(INTERPRETER, ctc_greedy_decoder)
{
    const int T = 3;
    const int N = 1;
    const int C = 3;
...
NGRAPH_TEST(INTERPRETER, ctc_greedy_decoder_f16)
{
    const int T = 3;
    const int N = 1;
    const int C = 3;
...
NGRAPH_TEST(INTERPRETER, ctc_greedy_decoder_multiple_batches)
{
    const int T = 3;
    const int N = 2;
    const int C = 3;
...
NGRAPH_TEST(INTERPRETER, ctc_greedy_decoder_single_batch_short_sequence)
{
    const int T = 3;
    const int N = 1;
    const int C = 3;
...
NGRAPH_TEST(INTERPRETER, ctc_greedy_decoder_merge)
{
    const int T = 3;
    const int N = 1;
    const int C = 3;
...
NGRAPH_TEST(INTERPRETER, ctc_greedy_decoder_single_no_merge)
{
    const int T = 3;
    const int N = 1;
    const int C = 3;
...
NGRAPH_TEST(INTERPRETER, ctc_greedy_decoder_multiple_sequences)
{
    const int T = 2;
    const int N = 2;
    const int C = 3;
