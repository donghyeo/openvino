...
NGRAPH_TEST(INTERPRETER, pad_exterior_1d)
{
...
NGRAPH_TEST(INTERPRETER, pad_negative_exterior_1d)
{
    const Shape data_shape{6};
    const auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, pad_negative_exterior_1d_check_limits)
{
    const Shape data_shape{6};
    const auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, pad_edge_1d)
{
    const Shape data_shape{6};
    const auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, pad_edge_1d_top_neg)
{
    const Shape data_shape{6};
    const auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, pad_edge_1d_top_neg_bigger_than_tensor)
{
    const Shape data_shape{6};
    const auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, pad_edge_1d_bottom_neg)
{
    const Shape data_shape{6};
    const auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, pad_edge_1d_bottom_neg_bigger_than_tensor)
{
    const Shape data_shape{6};
    const auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, pad_edge_2d)
{
...
NGRAPH_TEST(INTERPRETER, pad_edge_2d_with_neg)
{
    const Shape data_shape{3, 4};
    const auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, pad_reflect_1d)
{
    const Shape data_shape{6};
    const auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, pad_reflect_1d_top_neg)
{
    const Shape data_shape{6};
    const auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, pad_reflect_1d_top_neg_bigger_than_tensor)
{
    const Shape data_shape{6};
    const auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, pad_reflect_1d_bottom_neg)
{
    const Shape data_shape{6};
    const auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, pad_reflect_1d_bottom_neg_bigger_than_tensor)
{
    const Shape data_shape{6};
    const auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, pad_reflect_1d_multi_reflect)
{
...
NGRAPH_TEST(INTERPRETER, pad_reflect_2d)
{
    const Shape data_shape{3, 4};
    const auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, pad_reflect_2d_with_neg)
{
    const Shape data_shape{3, 4};
    const auto data = make_shared<op::Parameter>(element::f32, data_shape);
...
NGRAPH_TEST(INTERPRETER, pad_negative_exterior_2d)
{
...
NGRAPH_TEST(INTERPRETER, pad_negative_exterior_2d_all_negative)
{
...
NGRAPH_TEST(INTERPRETER, pad_exterior_2d_0x0)
{
...
NGRAPH_TEST(INTERPRETER, pad_exterior_2d_0x3)
{
...
NGRAPH_TEST(INTERPRETER, pad_exterior_2d_3x0)
{
...
NGRAPH_TEST(INTERPRETER, pad_exterior_4d_1x2x2x2)
{
...
NGRAPH_TEST(INTERPRETER, pad_negative_exterior_4d)
{
...
NGRAPH_TEST(INTERPRETER, pad_2channel_2image_asym)
{
...
NGRAPH_TEST(INTERPRETER, pad_symmetric)
{
    const Shape data_shape{2, 3};
    const auto data = make_shared<op::Parameter>(element::f32, data_shape);
