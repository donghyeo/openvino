...
NGRAPH_TEST(IE_GPU, onnx_provenance_tag_text)
{
...
NGRAPH_TEST(IE_GPU, onnx_provenance_only_output)
{
...
NGRAPH_TEST(IE_GPU, onnx_provenance_node_name_and_outputs)
{
    test::ProvenanceEnabler provenance_enabler;
...
NGRAPH_TEST(IE_GPU, onnx_provenance_multiple_outputs_op)
{
    test::ProvenanceEnabler provenance_enabler;
...
NGRAPH_TEST(IE_GPU, onnx_provenance_tagging_constants)
{
    test::ProvenanceEnabler provenance_enabler;
...
NGRAPH_TEST(IE_GPU, onnx_provenance_tagging_parameters)
{
    test::ProvenanceEnabler provenance_enabler;
