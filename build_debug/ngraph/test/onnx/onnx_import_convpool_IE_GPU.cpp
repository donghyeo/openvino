...
NGRAPH_TEST(IE_GPU, onnx_model_conv2d_strides_padding)
{
...
NGRAPH_TEST(IE_GPU, onnx_model_conv2d_strides_no_padding)
{
    // Convolution with strides=2 and padding=1
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_conv2d_strides_assymetric_padding)
{
    // Convolution with strides=2 and padding=1
...
NGRAPH_TEST(IE_GPU, onnx_model_conv2d_dilation_assymetric_pads_strides)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_conv3d_bias)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_conv_transpose_w_groups)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_average_pool_2d)
{
...
NGRAPH_TEST(IE_GPU, onnx_model_average_pool_2d_pads)
{
...
NGRAPH_TEST(IE_GPU, onnx_model_max_pool_2d_pads)
{
    // Pooling with strides=2 and padding=1
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_global_lp_pool_p0)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_global_lp_pool_p1)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_global_lp_pool_p2)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_global_lp_pool_p3)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_convtranspose_output_shape)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_convtranspose_output_shape_auto_pads_same_upper)
{
    auto function = onnx_import::import_onnx_model(file_util::path_join(
...
NGRAPH_TEST(IE_GPU, onnx_model_convtranspose_output_shape_auto_pads_same_lower)
{
    auto function = onnx_import::import_onnx_model(file_util::path_join(
...
NGRAPH_TEST(IE_GPU, onnx_model_convtranspose_groups_w_pads)
{
    auto function = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_model_convtranspose_groups_pads_bias)
{
    auto function = onnx_import::import_onnx_model(
