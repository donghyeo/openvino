...
NGRAPH_TEST(IE_GPU, onnx_const_folding_model_scatter_elements)
{
...
NGRAPH_TEST(IE_GPU, onnx_const_folding_model_non_zero_scalar)
{
    const auto fn = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_const_folding_model_non_zero_1d)
{
    const auto fn = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_const_folding_model_non_zero_1d_float)
{
    const auto fn = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_const_folding_model_non_zero_3d)
{
    const auto fn = onnx_import::import_onnx_model(
...
NGRAPH_TEST(IE_GPU, onnx_const_folding_model_non_zero_2d_bool)
{
    const auto fn = onnx_import::import_onnx_model(
